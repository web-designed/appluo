...
import './styles/datePicker_custom.css'
   ...
   const event4 = store.dispatch(addEvent({ cleanedAt:moment().valueOf(), createdAt:moment().valueOf(), note:'my note', cleaner: 'Steve', place: 'Bad'}))
   const event5 = store.dispatch(addEvent({ cleanedAt:moment().valueOf(), createdAt:moment().valueOf(), note:'my note', cleaner: 'Steve', place: 'Flur'}))
   const event6 = store.dispatch(addEvent({ cleanedAt:moment('2018-12-06').valueOf(), createdAt:moment().valueOf(), cleaner: 'Tom', place: 'Bad'}))
   const event7 = store.dispatch(addEvent({ cleanedAt:moment('2018-12-03').valueOf(), createdAt:moment().valueOf(), cleaner: 'Steve', place: 'Bad'}))
